...
/**
 * This is the main class for controlling the game. It loads the object database,
 * instantiates the player, chooses an object from the database, and then plays the game.
 * Note that it is an abstract class, meaning that it cannot be instantiated directly. To use
 * this class with your QuestionTree, subclass it and write your test code.
 * 
 * @author
 *
 */
public abstract class QuestionGameBase {
	...
	/**
	 * The constructor reads in the objects from a specified file, and chooses a random object.
	 * It also initializes the player, sending it the list of possible objects.
	 * 
	 * @param objectFileName the database file to be read
	 */
	...
	/**
	 * This method reinitializes the game variables to play again.
	 ...
	 * @throws Exception if the player loses
	 */
